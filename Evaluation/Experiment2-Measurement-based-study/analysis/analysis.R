...
for(i in 1:length(filenames)) {
  assign(paste('x_', filenames[i], sep=''), read.csv(paste("C:/Users/Teerath Das/Desktop/developer/result/data/cpudata/", filenames[i], ".csv", sep = ""), sep=",", header=T, row.names=NULL, stringsAsFactors=FALSE))
}

pdf(paste("C:/Users/Teerath Das/Desktop/developer/result/data/", "cpuanalysis", ".pdf", sep=""), width=10)
par(mar=c(8, 8, 5, 5))
...
pdf(paste("C:/Users/Teerath Das/Desktop/developer/result/data/", "memoryanalysis", ".pdf", sep=""), width=10)
par(mar=c(8, 8, 5, 5))
...
check_descriptive_values_cpu <- function() {
  ...
  for(i in 1:length(filenames)) {
    details <- assign(paste('x_', filenames[i], sep=''), read.csv(paste("C:/Users/Teerath Das/Desktop/developer/result/data/cpudata/", filenames[i], ".csv", sep = ""), sep=",", header=T, row.names=NULL, stringsAsFactors=FALSE))
